...
export class Helipad extends GrObject {
    ...
    constructor(x,y,z) {
        ...
        if (!helipadMaterial) {
            helipadMaterial = new THREEmod.MeshLambertMaterial({color:"#FF0000", side:THREEmod.DoubleSide});
        }
...
export class Helicopter extends GrObject {
    ...
    constructor(params={}) {
        ...
        let material = new THREEmod.MeshStandardMaterial({color:"#ff0000",side : THREEmod.DoubleSide});
